...
int main() {
    TString sample2 = "/home/oriana/scratch/code/user.apmorris.slim.PowhegPy8.output.root";


std::vector<TString> generatorNames = {"PowhegPy8", "PowhegPy6", "PowhegHpp", "MG5aMCPy8", "MG5aMChpp", "aMCNLOhpp" };

    plot_for_btagging::resultsForFile(sample2, "user.apmorris.slim.PowhegPy8.output.root");
...
void plot_for_btagging::resultsForFile(TString t_name, std::string s_name) {
   ...
   TString C_ALL_HPT_VS_JPT = t_name+"_C_hPT_vs_jPT.root";
    ...
    //Rebin 541
    //plot_B_541_ETA_L->Rebin(10);
    //plot_B_541_LOC_LT_low->Rebin(10);
    //plot_B_541_LOC_LT_high->Rebin(10);
