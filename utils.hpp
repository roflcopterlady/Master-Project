...
float tag[4] = {-0.7887, -0.5911, -0.0436, 0.4496};

float b_hadrons[10] = {511, 521, 531, 541, 5122, 5132, 5232, 5332, 5142, 5242};
float c_hadrons[7] = {411, 421, 431, 4122, 4132, 4232, 4332};
